...
int main(int argc, char** argv) {
  if (UtilSystem::getEnvAsString("BINANCE_USDS_FUTURES_API_KEY").empty()) {
    std::cerr << "Please set environment variable BINANCE_API_KEY" << std::endl;
    return EXIT_FAILURE;
  }
  std::cout << "API_KEY: " << UtilSystem::getEnvAsString("BINANCE_USDS_FUTURES_API_SECRET") << std::endl;
  ...
  std::cout << "SECRET_KEY: " << UtilSystem::getEnvAsString("BINANCE_API_SECRET") << std::endl;
